...
class ScrapMatcher:
    """
    MKYS ve TDMS hurda (SCRAP) hareketlerini eşleştirir.
    ...
    def match(
        ...
        mkys_scrap = [
            ...
            if movement.movement_type == MovementType.SCRAP
        ]
        ...
        for mkys_movement in mkys_scrap:
            ...
            matched_tifs.add(mkys_movement.tif_no)
        ...
        missing_in_mkys = [
            movement for movement in tdms_scrap if movement.tif_no not in matched_tifs
        ]
