...
class TransferMatcher:
    """
    MKYS ve TDMS transfer (virman/devir) hareketlerini eşleştirir.
    """
    ...
    def match(
        ...
        for mkys_movement in mkys_transfer:
        ...
        missing_in_mkys = [
            movement
            for movement in tdms_transfer
            if movement.tif_no not in matched_tifs
        ]
